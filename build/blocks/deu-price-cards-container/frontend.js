...
/*!**********************************************************!*\
  !*** ./src/blocks/deu-price-cards-container/frontend.js ***!
  \**********************************************************/
document.addEventListener("DOMContentLoaded", () => {
  const switcherButtonLeft = document.querySelector(".switcher__btn--left");
  const switcherButtonLeftBg = document.querySelector(".switcher__btn--left-bg");
  const switcherButtonRight = document.querySelector(".switcher__btn--right");
  const switcherButtonRightBg = document.querySelector(".switcher__btn--right-bg");
